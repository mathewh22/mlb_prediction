# -*- coding: utf-8 -*-
"""
Created on Tue Nov 12 15:46:01 2024
...
updated_rows = []
with open('2023_filtered_pitching_data.csv', 'r') as data_file: 
...
with open('2023_pitching_data_cleaned.csv', 'w', newline='') as updated_file:
